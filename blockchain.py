...
fakeUsers = ["Elena", "Sergey", "Dmitry", "Natalia", "Vladimir",
                 "Ludmila", "Evgeny", "Sofia", "Viktor", "Alina",
                 "Boris", "Maria", "Pavel", "Galina", "Mikhail",
                 "Tatyana", "Igor", "Svetlana", "Roman", "Yana"]
...
def start(num, path):
    ...
    for i in range(1, num):
        ...
        for j in range(random.randint(1, 6)):
            sender = fakeUsers[random.randint(1, 19)]
            receiver = fakeUsers[random.randint(1, 19)]
            amount = random.randint(1, 100)
            testChain.addTransaction(Transaction(sender, receiver, amount))
